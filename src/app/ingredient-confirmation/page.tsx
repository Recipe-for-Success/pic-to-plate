  ...
  return (
    <>
      ...
      <div className="flex justify-center text-center">
        <p>The name of the product you scanned was BRAND NAME PRODUCT<br></br>We identified this product as INGREDIENT NAME</p>
      </div>
      <div className="flex flex-col m-5 p-5 justify-center">
          ...
          <input type="text" placeholder="Actual Ingredient Name" className="mx-auto max-w-[400px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></input>
      </div>
    </>
  )
}
