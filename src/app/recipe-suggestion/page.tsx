        ...
        <div>
          <div className="flex m-2 p-2 flex-col mx-auto max-w-[400px] bg-white/20  rounded-md shadow-sm cursor-pointer border-gray-50 hover:border-black">
            ...
            <div className="flex justify-end">
              <TextButton className="" text="More Info" onClick={func} route="/recipe-info"></TextButton>
            </div>
          </div>
          <div className="flex m-2 p-2 flex-col mx-auto max-w-[400px] bg-white/20  rounded-md shadow-sm cursor-pointer border-gray-50 hover:border-black">
          ...
          <div className="flex justify-center">
            ...
            <TextButton className="" text="Back to Ingredient Editor" onClick={func} route="/ingredients-list"></TextButton>
          </div>
        </div>
      </div>
    </>
